      ...
      <div className="flex-1 max-w-[1000px] mx-auto px-4 py-8">
        ...
        <div className="flex flex-col lg:flex-row lg:gap-16">
          ...
          <div className="lg:w-[60%]">
            ...
            {/* Image upload section - exact positioning */}
            <div className="mb-8 flex">
              <div className="w-[125px] h-[125px] border border-gray-200 flex items-center justify-center">
                {resumeData.photo ? (
                  <img 
            ...
            {/* Form fields - exact spacing and layout */}
